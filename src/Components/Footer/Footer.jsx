        ...
        <div class="flex flex-col">
          <div class="flex mt-24 mb-12 flex-row justify-between">
            ...
            <div class="flex flex-row space-x-8 items-center justify-between">
              <a target="_blank" href="https://www.linkedin.com/in/yashoda-babal">
                <svg
              ...
              <a href="https://github.com/Yashodababal21">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <p class="w-full text-center my-12 text-gray-600">Made by Yashoda</p>
        </div>
      </div>
    </div>
  );
